...
public class AntiqueAtlasKeybindings {
	public static final KeyMapping ATLAS_KEYMAPPING = new KeyMapping("key.antique_atlas.open", InputConstants.Type.KEYSYM, 77, KeyMapping.Category.register(net.minecraft.resources.Identifier.fromNamespaceAndPath("antique_atlas", "category")));
